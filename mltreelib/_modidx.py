...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'mltreelib.base.tree': { 'mltreelib.base.tree.BaseDecisionTree': ( '01_APIS/basetree.html#basedecisiontree',
            ...
            'mltreelib.data.utility': { 'mltreelib.data.utility.get_dataset': ( '01_APIS/dataset_utils.html#get_dataset',
                                                                                'mltreelib/data/utility.py'),
                                        'mltreelib.data.utility.show_data': ( '01_APIS/dataset_utils.html#show_data',
                                                                              'mltreelib/data/utility.py')},
